...
With the described setup, the network was trained with three differnet seeds for the weight initialization.
\begin{figure}[ht]
    \centering
    \includegraphics[width=1.0\linewidth]{mnist-acc-largest-784-392.png}
    \caption{
