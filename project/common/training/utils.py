...
def train_and_evaluate(
    ...
    for epoch in epochs:
        ...
        if logger is not None and log_every is not None and epoch % log_every == 0 and epoch != epochs[-1]:
            raise NotImplementedError('Need to change the implementation a bit. low priority')
